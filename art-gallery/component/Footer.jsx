                ...
                <div className="flex flex-col md:flex-row justify-between gap-10 pb-10 border-b border-white/10">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <ul className="flex flex-col gap-3 text-[0.95rem] text-white/70">
                            <li className="flex items-center gap-2"><Mail size={18} /> hello@helenartgallery.com</li>
                            <li className="flex items-center gap-2"><MapPin size={18} /> Lagos, Nigeria</li>
                            <li className="flex items-center gap-2"><Phone size={18} /> +234 800 000 0000</li>
                        </ul>
                    </div>
                </div>
